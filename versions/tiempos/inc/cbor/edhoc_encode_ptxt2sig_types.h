...
#ifndef EDHOC_ENCODE_PTXT2SIG_TYPES_H__
#define EDHOC_ENCODE_PTXT2SIG_TYPES_H__
...
struct ptxt2sig {
	union {
		int32_t ptxt2sig_C_R_int;
		struct zcbor_string ptxt2sig_C_R_bstr;
	};
	enum {
		ptxt2sig_C_R_int_c,
		ptxt2sig_C_R_bstr_c,
	...
	union {
		struct map2 ptxt2sig_ID_CRED_X_map2_m;
		struct zcbor_string ptxt2sig_ID_CRED_X_bstr;
		int32_t ptxt2sig_ID_CRED_X_int;
	};
	enum {
		ptxt2sig_ID_CRED_X_map2_m_c,
		ptxt2sig_ID_CRED_X_bstr_c,
		ptxt2sig_ID_CRED_X_int_c,
	} ptxt2sig_ID_CRED_X_choice;
	struct zcbor_string ptxt2sig_SGN_or_MAC_2;
	struct zcbor_string ptxt2sig_EAD_2;
	bool ptxt2sig_EAD_2_present;
};
...
#endif /* EDHOC_ENCODE_PTXT2SIG_TYPES_H__ */
