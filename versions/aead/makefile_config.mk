...
FEATURES += -DMESSAGE_4 # This option implies message_4 is mandatory
...
CRYPTO_ENGINE += -DTINYCRYPT #JTODO: Rafa's code do enable it; IOT Devices low power criptography 
