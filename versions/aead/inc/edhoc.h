...
struct other_party_cred {
	...
	struct byte_array id_cred_psk; /*ID_CRED_x of the other party*/
	struct byte_array cred_psk; /*CBOR encoded credentials*/
};
...
struct edhoc_responder_context {
	...
	struct byte_array id_cred_psk; /*ID_CRED_x of the responder*/
...
struct edhoc_initiator_context {
	...
	struct byte_array id_cred_psk; /*ID_CRED_x of the initiator*/
	struct byte_array cred_psk; /*CBOR encoded credentials*/
