...
#ifndef EDHOC_DECODE_PTXT3SIG_TYPES_H__
#define EDHOC_DECODE_PTXT3SIG_TYPES_H__
...
struct ptxt3sig {
	union {
		struct map3 ptxt3sig_ID_CRED_I_map3_m;
		struct zcbor_string ptxt3sig_ID_CRED_I_bstr;
		int32_t ptxt3sig_ID_CRED_I_int;
	};
	enum {
		ptxt3sig_ID_CRED_I_map3_m_c,
		ptxt3sig_ID_CRED_I_bstr_c,
		ptxt3sig_ID_CRED_I_int_c,
	} ptxt3sig_ID_CRED_I_choice;
	struct zcbor_string ptxt3sig_SGN_or_MAC_3;
	struct zcbor_string ptxt3sig_EAD_3;
	bool ptxt3sig_EAD_3_present;
};
...
#endif /* EDHOC_DECODE_PTXT3SIG_TYPES_H__ */
