...
# ---> DECODERS
python3 $ZCBOR code \
  -c $MODELS_PATH/edhoc_plaintext.cddl \
  -d \
  -t ptxt2sig \
  --oc $SRC/edhoc_decode_ptxt2sig.c \
  --oh $INC/edhoc_decode_ptxt2sig.h \
  --include-prefix $INC_PATH_IN_C_FILES

python3 $ZCBOR code \
  -c $MODELS_PATH/edhoc_plaintext.cddl \
  -d \
  -t ptxt2psk \
  --oc $SRC/edhoc_decode_ptxt2psk.c \
  --oh $INC/edhoc_decode_ptxt2psk.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -d \
  -t ptxt3sig \
  --oc $SRC/edhoc_decode_ptxt3sig.c \
  --oh $INC/edhoc_decode_ptxt3sig.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -d \
  -t ptxt3psk \
  --oc $SRC/edhoc_decode_ptxt3psk.c \
  --oh $INC/edhoc_decode_ptxt3psk.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -e \
  -t ptxt2sig \
  --oc $SRC/edhoc_encode_ptxt2sig.c \
  --oh $INC/edhoc_encode_ptxt2sig.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -e \
  -t ptxt2psk \
  --oc $SRC/edhoc_encode_ptxt2psk.c \
  --oh $INC/edhoc_encode_ptxt2psk.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -e \
  -t ptxt3sig \
  --oc $SRC/edhoc_encode_ptxt3sig.c \
  --oh $INC/edhoc_encode_ptxt3sig.h \
  --include-prefix $INC_PATH_IN_C_FILES
...
python3 $ZCBOR code \
  ...
  -e \
  -t ptxt3psk \
  --oc $SRC/edhoc_encode_ptxt3psk.c \
  --oh $INC/edhoc_encode_ptxt3psk.h \
  --include-prefix $INC_PATH_IN_C_FILES
